...
function TopPlusProduct() {
    ...
    const sortedData2 = produk2.data.sort((b,a) => a.stock - b.stock)
    const sortedDataT = produk2.data.sort((b,a) => a.stock - b.stock)
        ...
        <div className="container my-5">
            <div className="row">
                <div className="col col-lg-9">
                    <h3 className="text-white mb-4">Produk Stok Tinggi</h3>
                </div>
            ...
            {views === true ? (
                <div className="row justify-content-center chartDiagram pb-4">
                    <div className="col text-center">
                        ...
                        {/* <LineChart width={1100} height={400} data={produk2.data} 
                            margin={{
                                top: 5,
                                right: 30,
                                left: 30,
                ...
                <div className="row justify-content-center mt-3 pb-4 tableContent">
                    <div className="row">
